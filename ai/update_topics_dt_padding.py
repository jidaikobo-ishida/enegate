...
# #topics .topicslist dt の padding を 20px 0 10px !important; に変更する
target = """    #topics .topicslist dt {
        padding: 0 !important;
...
replacement = """    #topics .topicslist dt {
...
if target_crlf in content_crlf:
    ...
    print("Successfully updated #topics .topicslist dt padding to 20px 0 10px in common.css.")
else:
