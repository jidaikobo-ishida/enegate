...
# 2632行目の font-size: 0.8em !important; を 1em !important; に変更する
target = """    .scrolltable::before,
    .scrolltable::after {
...
if target_crlf in content_crlf:
    ...
    print("Successfully updated .scrolltable pseudo font-size to 1em in common.css.")
else:
